...
public class Main {
    ...
    private static boolean verificaDuplicato(String autore, String titolo, int nLibri, ArrayList<Libro> scaffale) throws Exception {
        for (int i = 0; i < nLibri; i++) {
            if (scaffale.get(i).autore.equals(autore) && scaffale.get(i).titolo.equals(titolo)) {
